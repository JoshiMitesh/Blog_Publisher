...
// Load Let's Encrypt certificate
const privateKey = fs.readFileSync('/etc/letsencrypt/live/atomo.in-0001/privkey.pem', 'utf8');
const certificate = fs.readFileSync('/etc/letsencrypt/live/atomo.in-0001/fullchain.pem', 'utf8');
...
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://atomo.in');
...
httpsServer.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`- Local: https://3.110.51.14:${PORT}`);
  console.log(`- Network: https://3.110.51.14:${PORT}`);
  console.log(`API endpoint: https://3.110.51.14:${PORT}/api/blogs`);
});
